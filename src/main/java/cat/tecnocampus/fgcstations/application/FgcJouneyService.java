...
public class FgcJouneyService {
    ...
    public List<JourneyDTO> getAllJourneysDTO() {
        ...
        for (Journey journey : journeys) {
            journeyDTOs.add(new JourneyDTO(journey.getOrigin().toString(), journey.getDestination().toString()));
        }
        return journeyDTOs;
    }
    ...
    public JourneyId getJourneyId(String origin, String destination) {
        ...
        return new JourneyId(journey.getOrigin().toString(), journey.getDestination().toString());
    }
}
